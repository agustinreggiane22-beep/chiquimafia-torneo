(function () {
  ...
  function buildTournament(state){
    ...
    const allNames=uniqueNames([...active,...matches.flatMap(match=>[...match.white,...match.black])]),canonical=new Map(allNames.map(name=>[key(name),name])),names=uniqueNames(active);
