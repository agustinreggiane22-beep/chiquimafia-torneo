(function () {
  ...
  function buildTournament(state){
    ...
    return{standings,matches,players:names,stats:standings.map(x=>({...x})),history,pointsHistory:history,results:[],mappings:[{type:'Google Apps Script',live:true}],allLive:true};
  }
